...
class TicketHistoryControllerTests {
    ...
    fun getAllTicketHistory() {
        ...
        Assertions.assertEquals(body[0]["currentExpertId"], history1ticket1.currentExpert!!.email)
        Assertions.assertEquals(body[0]["userId"], history1ticket1.user!!.email)
        ...
        Assertions.assertEquals(body[1]["currentExpertId"], history2ticket2.currentExpert!!.email)
        Assertions.assertEquals(body[1]["userId"], history2ticket2.user!!.email)
        ...
        Assertions.assertEquals(body[2]["currentExpertId"], history3ticket2.currentExpert!!.email)
        Assertions.assertEquals(body[2]["userId"], history3ticket2.user!!.email)
    ...
    fun getExistingTicketHistory() {
        ...
        Assertions.assertEquals(body[0]["currentExpertId"], history2ticket2.currentExpert!!.email)
        Assertions.assertEquals(body[0]["userId"], history2ticket2.user!!.email)
        ...
        Assertions.assertEquals(body[1]["currentExpertId"], history3ticket2.currentExpert!!.email)
        Assertions.assertEquals(body[1]["userId"], history3ticket2.user!!.email)
