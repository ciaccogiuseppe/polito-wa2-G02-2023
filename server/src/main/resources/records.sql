...
bigint;
BEGIN
select nextval('profiles_id_seq')
into id;
...
insert into category_assigned(expert_id, category_id)
values (id_e1, id);
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000103', 'Samsung Crystal UHD 7 Series', (SELECT brands.id FROM brands WHERE name = 'Samsung'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000196', 'IBM WebSphere Application Server', (SELECT brands.id FROM brands WHERE name = 'IBM'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000205', 'Salesforce Sales Cloud', (SELECT brands.id FROM brands WHERE name = 'Salesforce'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000206', 'Salesforce Service Cloud', (SELECT brands.id FROM brands WHERE name = 'Salesforce'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000207', 'Salesforce Marketing Cloud', (SELECT brands.id FROM brands WHERE name = 'Salesforce'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000208', 'Salesforce Commerce Cloud', (SELECT brands.id FROM brands WHERE name = 'Salesforce'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000221', 'Symantec Endpoint Protection', (SELECT brands.id FROM brands WHERE name = 'Symantec'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000222', 'Symantec Backup Exec', (SELECT brands.id FROM brands WHERE name = 'Symantec'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000223', 'Symantec Norton Security', (SELECT brands.id FROM brands WHERE name = 'Symantec'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000224', 'Symantec Ghost Solution Suite', (SELECT brands.id FROM brands WHERE name = 'Symantec'), id);

select nextval('categories_id_seq')
into id;
insert into categories(id, name)
values (id, 'STORAGE_DEVICE');
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000227', 'Seagate Backup Plus Portable HDD', (SELECT brands.id FROM brands WHERE name = 'Seagate'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000228', 'Seagate FireCuda Gaming SSD', (SELECT brands.id FROM brands WHERE name = 'Seagate'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000229', 'Western Digital Blue SSD', (SELECT brands.id FROM brands WHERE name = 'Western Digital'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000230', 'Western Digital Red NAS HDD', (SELECT brands.id FROM brands WHERE name = 'Western Digital'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000236', 'Samsung X5 Thunderbolt 3 SSD', (SELECT brands.id FROM brands WHERE name = 'Samsung'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000241', 'Kingston A2000 NVMe PCIe SSD', (SELECT brands.id FROM brands WHERE name = 'Kingston'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000245', 'SanDisk Ultra microSD Card', (SELECT brands.id FROM brands WHERE name = 'SanDisk'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000246', 'SanDisk SSD PLUS', (SELECT brands.id FROM brands WHERE name = 'SanDisk'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000247', 'SanDisk Extreme Portable SSD', (SELECT brands.id FROM brands WHERE name = 'SanDisk'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000248', 'SanDisk Cruzer USB Flash Drive', (SELECT brands.id FROM brands WHERE name = 'SanDisk'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000251', 'Toshiba Canvio Basics Portable HDD', (SELECT brands.id FROM brands WHERE name = 'Toshiba'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
-- Monitors
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000257', 'Dell Ultrasharp U2719D Monitor', (SELECT brands.id FROM brands WHERE name = 'Dell'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000260', 'LG 34WK650-W Ultrawide Monitor', (SELECT brands.id FROM brands WHERE name = 'LG'), id);
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000262', 'Corsair K70 RGB Mechanical Keyboard', (SELECT brands.id FROM brands WHERE name = 'Corsair'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000263', 'Razer Huntsman Elite Gaming Keyboard', (SELECT brands.id FROM brands WHERE name = 'Razer'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
-- Mice
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000265', 'Logitech MX Master 3 Wireless Mouse', (SELECT brands.id FROM brands WHERE name = 'Logitech'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000266', 'Razer DeathAdder V2 Gaming Mouse', (SELECT brands.id FROM brands WHERE name = 'Razer'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000267', 'Corsair M65 RGB Elite Gaming Mouse', (SELECT brands.id FROM brands WHERE name = 'Corsair'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
-- Headphones
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000269', 'Sony WH-1000XM4 Wireless Headphones', (SELECT brands.id FROM brands WHERE name = 'Sony'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000272', 'JBL Quantum 800 Gaming Headset', (SELECT brands.id FROM brands WHERE name = 'JBL'), id);

-- Speakers
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000273', 'Sonos One (Gen 2) Smart Speaker', (SELECT brands.id FROM brands WHERE name = 'Sonos'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000274', 'Bose SoundLink Revolve+ Portable Speaker', (SELECT brands.id FROM brands WHERE name = 'Bose'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000275', 'JBL Flip 5 Waterproof Bluetooth Speaker', (SELECT brands.id FROM brands WHERE name = 'JBL'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
-- Printers
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000277', 'HP OfficeJet Pro 9015 All-in-One Printer', (SELECT brands.id FROM brands WHERE name = 'HP'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000278', 'Epson EcoTank ET-4760 Wireless Printer', (SELECT brands.id FROM brands WHERE name = 'Epson'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000279', 'Canon PIXMA TR8520 Wireless Printer', (SELECT brands.id FROM brands WHERE name = 'Canon'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000280', 'Brother HL-L2395DW Laser Printer', (SELECT brands.id FROM brands WHERE name = 'Brother'), id);

-- Routers
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000281', 'NETGEAR Nighthawk AX12 Wi-Fi Router', (SELECT brands.id FROM brands WHERE name = 'NETGEAR'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000282', 'TP-Link Archer AX6000 Wi-Fi Router', (SELECT brands.id FROM brands WHERE name = 'TP-Link'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000283', 'Linksys EA7500 Dual-Band Wi-Fi Router', (SELECT brands.id FROM brands WHERE name = 'Linksys'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000284', 'ASUS RT-AC68U AC1900 Wi-Fi Router', (SELECT brands.id FROM brands WHERE name = 'ASUS'), id);

-- Webcams
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000285', 'Logitech C920 HD Pro Webcam', (SELECT brands.id FROM brands WHERE name = 'Logitech'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000286', 'Microsoft LifeCam HD-3000 Webcam', (SELECT brands.id FROM brands WHERE name = 'Microsoft'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000287', 'Razer Kiyo Streaming Webcam', (SELECT brands.id FROM brands WHERE name = 'Razer'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000288', 'AUKEY FHD Webcam', (SELECT brands.id FROM brands WHERE name = 'AUKEY'), id);

-- Power Banks
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000289', 'Anker PowerCore 10000 Portable Charger', (SELECT brands.id FROM brands WHERE name = 'Anker'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000290', 'RAVPower 26800mAh Power Bank', (SELECT brands.id FROM brands WHERE name = 'RAVPower'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000291', 'AUKEY 20000mAh Power Bank', (SELECT brands.id FROM brands WHERE name = 'AUKEY'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000292', 'Samsung 10000mAh Wireless Power Bank', (SELECT brands.id FROM brands WHERE name = 'Samsung'),
        id);
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000294', 'Samsung Galaxy Watch Active2', (SELECT brands.id FROM brands WHERE name = 'Samsung'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000295', 'Fitbit Versa 3', (SELECT brands.id FROM brands WHERE name = 'Fitbit'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000296', 'Garmin Forerunner 245 Music', (SELECT brands.id FROM brands WHERE name = 'Garmin'), id);

-- VR Headsets
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000297', 'Oculus Quest 2 VR Headset', (SELECT brands.id FROM brands WHERE name = 'Oculus'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000298', 'HTC Vive Cosmos Elite VR Headset', (SELECT brands.id FROM brands WHERE name = 'HTC'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000306', 'SanDisk Extreme Portable SSD', (SELECT brands.id FROM brands WHERE name = 'SanDisk'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
...
-- Fitness Trackers
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000309', 'Fitbit Charge 4 Fitness Tracker', (SELECT brands.id FROM brands WHERE name = 'Fitbit'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000310', 'Garmin Venu 2 Fitness Tracker', (SELECT brands.id FROM brands WHERE name = 'Garmin'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000311', 'Samsung Galaxy Fit2 Fitness Tracker', (SELECT brands.id FROM brands WHERE name = 'Samsung'),
        id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000312', 'Xiaomi Mi Band 6 Fitness Tracker', (SELECT brands.id FROM brands WHERE name = 'Xiaomi'), id);

-- Action Cameras
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000313', 'GoPro HERO9 Black Action Camera', (SELECT brands.id FROM brands WHERE name = 'GoPro'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000314', 'DJI Osmo Action Camera', (SELECT brands.id FROM brands WHERE name = 'DJI'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000315', 'Sony FDR-X3000 Action Camera', (SELECT brands.id FROM brands WHERE name = 'Sony'), id);
INSERT INTO products(product_id, name, brand_id, category_id)
VALUES ('0000000000316', 'Insta360 ONE R Action Camera', (SELECT brands.id FROM brands WHERE name = 'Insta360'), id);


INSERT INTO items (serial_num, duration_months, uuid, valid_from_timestamp, product_id, client_id)
VALUES (203241506, 24, '9fcebd14-fa40-4f11-a11f-84391df346da', '2023-06-21 19:10:54.961201', '0000000000025', 1);
INSERT INTO items (serial_num, duration_months, uuid, valid_from_timestamp, product_id, client_id)
VALUES (633020516, 12, 'e559a864-d32d-49db-bc52-7182e38036bb', '2023-06-21 19:11:23.318321', '0000000000112', 1);
INSERT INTO items (serial_num, duration_months, uuid, valid_from_timestamp, product_id, client_id)
VALUES (203040506, 12, '72895077-097e-4e84-9917-5a57d0b56196', '2023-06-21 19:09:27.839294', '0000000000023', 1);
INSERT INTO items (serial_num, duration_months, uuid, valid_from_timestamp, product_id, client_id)
VALUES (213244506, 12, 'a78d44fa-6137-4b79-8d6c-afc0450267ed', '2021-06-21 19:12:05.853000', '0000000000189', 1);

INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id,
                     serial_num)
VALUES (1, '2023-06-21 19:47:14.726903', e'am reaching out to you regarding an issue I am experiencing with my LG Velvet smartphone\'s touch screen. I am encountering difficulties with the touch functionality and would greatly appreciate your assistance in resolving this problem.

Issue Description:
The touch screen on my LG Velvet smartphone has become unresponsive,
        making it impossible for me to interact with the device using touch gestures. I have tried various troubleshooting steps but have been unable to restore the touch screen functionality.', 2, 'IN_PROGRESS', 'Touch screen not working', 1, 3, '0000000000025', 203241506);
        INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id, serial_num) VALUES (2, '2023-06-21 20:04:23.758173', e'I am writing to report an issue that I have encountered with my Sony Bravia X70J television. I am experiencing distorted audio output,
        which is significantly affecting my viewing experience. I kindly request your assistance in resolving this problem promptly.

Issue Description:
While watching various programs on my Sony Bravia X70J TV,
        I noticed that the audio output has become distorted and unclear. The sound appears muffled, with a noticeable
        loss of clarity and depth.This issue persists across all audio sources, including built-in TV apps, external
        devices connected via HDMI, and broadcast channels.
    ...
    Adjusted audio settings: I have reviewed and adjusted the audio settings on my Sony Bravia X70J TV,
        ensuring that they are optimized for the best audio quality. However, the distortion issue remains unresolved.
    Tested different audio sources: I have tested the TV with various audio sources,
        including different channels and streaming services, to rule out the possibility of a specific source causing
        the distortion.Unfortunately, the problem persists across all sources.
    Checked external devices: I have disconnected all external devices connected to the TV,
        such as soundbars or AV receivers, to ensure that they are not causing the audio distortion.However,
        the issue still persists when using the TV\'s built-in speakers.', 0, 'OPEN',
        'Distorted Audio Output on Sony Bravia X70J TV', 1, 3, '0000000000112', 633020516);
INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id,
                     serial_num)
VALUES (4, '2023-06-20 20:04:23.758000', e'I am reaching out to you regarding a pressing concern with my Sony Bravia X70J television. Unfortunately, I have been experiencing consistent audio distortion, severely impacting my viewing enjoyment. I humbly request your prompt assistance in resolving this matter.
...
To address the audio distortion, I have undertaken the following troubleshooting steps, but have been unable to resolve the issue:
    ...
    Adjusted audio settings: I carefully reviewed and optimized the TV\'s audio settings,
        aiming to enhance the sound quality. Unfortunately, the distortion problem persists despite these adjustments.

    Tested different audio sources: I conducted tests using various audio sources to eliminate the possibility of a specific source causing the distortion. Regrettably,
        the issue persists across all sources, indicating an underlying concern.

    Checked external devices: As a precautionary measure, I disconnected all external devices connected to the TV,
        such as soundbars or AV receivers. However, even when relying solely on the TV\'s internal speakers, the audio distortion persists.
...
INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id,
                     serial_num)
VALUES (5, '2023-06-20 20:04:23.758000', e'I am writing to report a critical issue with my Sony Bravia X70J television. The audio output is consistently distorted, negatively impacting my viewing experience. I kindly request your prompt assistance in resolving this problem.
...
I have attempted to address the audio distortion issue with the following unsuccessful troubleshooting steps:
    ...
    Tested different audio sources: I tested various audio sources to rule out any specific source causing the issue,
        but the distortion persists across all sources.

    Checked external devices: I disconnected all external devices to eliminate them as potential causes,
        yet the distortion persists when using the TV\'s built-in speakers.
...
Despite my efforts to troubleshoot the issue, the audio distortion problem remains unresolved. Here are the steps I have taken:
    ...
    Adjusted audio settings: I thoroughly reviewed and optimized the TV\'s audio settings to ensure the best sound quality. However,
        the distortion persists despite these adjustments.

    Tested different audio sources: I extensively tested various audio sources to identify any specific cause of the distortion. Unfortunately,
        the problem persists across all sources.

    Checked external devices: I disconnected all external devices connected to the TV,
        such as soundbars or AV receivers, to eliminate potential interference.However,
        the audio distortion persists when using the TV\'s built-in speakers.
...
INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id,
                     serial_num)
VALUES (17, '2023-06-19 20:04:23.758000', e'I am writing to report a critical issue with my Sony Bravia X70J television. The audio output is consistently distorted, negatively impacting my viewing experience. I kindly request your prompt assistance in resolving this problem.
...
INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id,
                     serial_num)
VALUES (7, '2023-06-20 20:04:23.758000', e'I am writing to bring to your attention a pressing matter regarding my Sony Bravia X70J television. Regrettably, I have encountered a persistent issue with distorted audio output that significantly impairs my viewing experience. Therefore, I am reaching out to your esteemed team in the hope of a prompt resolution.

Description of the Issue:
During my regular usage of the Sony Bravia X70J TV, I have noticed a distressing audio distortion that affects the quality of the sound. The audio output exhibits a muffled and unclear nature, depriving me of the clarity and depth I expect from my viewing sessions. This frustrating problem persists across all audio sources, encompassing the TV\'s built-in apps, external
        devices connected via HDMI, and even the broadcast channels.
        Steps Taken for Troubleshooting :
        In my sincere efforts to address the audio distortion concern,
        I have undertaken the following troubleshooting measures, unfortunately without success:

    Adjusted audio settings: I diligently reviewed and optimized the audio settings on my Sony Bravia X70J TV,
        striving to achieve the finest audio quality possible. However, regrettably, these adjustments did not resolve the distortion issue.

    Tested different audio sources: To eliminate the possibility of a specific source causing the problem,
        I conscientiously tested the TV with various audio sources,
        including different channels and streaming services. Sadly, the audio distortion persisted across all sources,
        indicating a more intrinsic problem.

    Checked external devices: In an attempt to isolate the root cause,
        I meticulously disconnected all external devices connected to the TV,
        such as soundbars or AV receivers. Despite this precautionary measure,
        the audio distortion remains prevalent even when utilizing the TV\'s internal speakers.
...
INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id,
                     serial_num)
VALUES (8, '2023-06-20 20:04:23.758000', e'I am writing to seek immediate assistance regarding an audio distortion issue on my Sony Bravia X70J television. The sound output is consistently distorted, significantly affecting my viewing experience. I kindly request your prompt attention and resolution of this problem.
...
INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id,
                     serial_num)
VALUES (9, '2023-06-20 20:04:23.758000', e'I am writing to report a critical issue with my Sony Bravia X70J television. The audio output is consistently distorted, negatively impacting my viewing experience. I kindly request your prompt assistance in resolving this problem.
...
INSERT INTO tickets (id, created_timestamp, description, priority, status, title, client_id, expert_id, product_id,
                     serial_num)
VALUES (3, '2023-06-20 20:04:23.758000', e'I am writing to bring to your attention a pressing matter regarding my Sony Bravia X70J television. Regrettably, I have encountered a persistent issue with distorted audio output that significantly impairs my viewing experience. Therefore, I am reaching out to your esteemed team in the hope of a prompt resolution.
