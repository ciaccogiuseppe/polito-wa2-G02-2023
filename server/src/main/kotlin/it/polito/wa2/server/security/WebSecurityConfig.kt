...
class WebSecurityConfig(val jwtAuthConverter: JwtAuthConverter) {
    ...
    fun securityFilterChain(httpSecurity: HttpSecurity): SecurityFilterChain {
        httpSecurity.authorizeHttpRequests()
            ...
            .requestMatchers(HttpMethod.GET, "/validatemail/**").permitAll()
            ...
            .requestMatchers(HttpMethod.GET, "/API/validateEmail/**").permitAll()
            .requestMatchers(HttpMethod.PUT, "/API/validateEmail/**").permitAll()
