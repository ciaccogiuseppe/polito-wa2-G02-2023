...
class TicketController(private val ticketService: TicketService) {
    ...
    fun managerGetTicketsFiltered(
        ...
        checkFilterParameters(
            ...
            maxPriority,
            productId,
            createdAfter?.let { Timestamp.valueOf(createdAfter) },
            createdBefore?.let { Timestamp.valueOf(createdBefore) },
            expertEmail,
            status
        )
