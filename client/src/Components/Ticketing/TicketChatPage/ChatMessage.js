    ...
    >
      ...
      >
        {user.role === "EXPERT" && role === "Client" ? (
          <div
            style={{ fontSize: "15px", textAlign: "center", cursor: "pointer" }}
            onClick={() => navigate("/profiledata/" + props.sender)}
          >
            {name}
          </div>
        ) : (
        ...
        <div
          style={{ fontSize: "11px", textAlign: "center", marginTop: "2px" }}
        >
          {timestamp}
        </div>
      </div>
          ...
          {imageList.map((img, index) =>
            isImage(img.attachment) ? (
              ...
              >
                ...
                >
                  {img.name.substring(24, img.name.length)}
                </div>
              </a>
            )
          )}
