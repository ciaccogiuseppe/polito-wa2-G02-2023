            ...
            <div style={{ alignItems: "center", alignSelf: "center" }}>
                <table className="table  roundedTable" style={{ alignContent: "center", width: "90%", margin: "auto", marginTop: "20px" }}>
                    ...
                    <tbody>
                        ...
                        {ticketList.map(t => <TicketHistoryTR
                            id={t.ticketId}
                            user={t.userEmail}
                            expert={t.currentExpertEmail}
                            oldStatus={t.oldState}
                            newStatus={t.newState}
                            updated={
                                new Date(t.updatedTimestamp).getDate().toString().padStart(2, "0") + "/" +
                                (new Date(t.updatedTimestamp).getMonth() + 1).toString().padStart(2, "0") + "/" +
                                new Date(t.updatedTimestamp).getFullYear()}
                        />)}
