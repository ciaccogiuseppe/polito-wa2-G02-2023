    ...
    datasets: [
      {
        label: "Tickets",
        data: priorities,
        backgroundColor: ["#ad3b1799", "#f8aa4899", "#47bd7899", "#a1a1a199"],
        borderColor: ["#ad3b17", "#f8aa48", "#47bd78", "#a1a1a1"],
        hoverBackgroundColor: ["#ad3b17", "#f8aa48", "#47bd78", "#a1a1a1"],
        borderWidth: 2,
      },
    ],
  };
  ...
  useEffect(
    () => {
      getAllTicketsManager({
        ...
        let ticketsData = tickets.reduce((r, t) => {
        ...
        for (let i = 0; i < numDays; ++i) {
          ...
          values.open.push(
            dataOfDay ? (dataOfDay["OPEN"] ? dataOfDay["OPEN"] : 0) : 0
          );
          values.closed.push(
            dataOfDay ? (dataOfDay["CLOSED"] ? dataOfDay["CLOSED"] : 0) : 0
          );
          values.reopened.push(
            dataOfDay ? (dataOfDay["REOPENED"] ? dataOfDay["REOPENED"] : 0) : 0
          );
          values.inProgress.push(
            dataOfDay
          ...
          values.resolved.push(
            dataOfDay ? (dataOfDay["RESOLVED"] ? dataOfDay["RESOLVED"] : 0) : 0
          );
        }
        // statuses
      ...
      <div className="CenteredButton">
        ...
        >
          ...
          >
            ...
            <Col xs={1}>
              <Form.Select
                value={numDays === 1 ? "Today" : "Last " + numDays + " days"}
                onChange={(e) => {
                  setNumDays(getNumDaysFromString(e.target.value));
                }}
