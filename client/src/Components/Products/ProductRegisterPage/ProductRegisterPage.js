...
function ProductRegisterPage(props) {
    ...
    return <>
        ...
        <div className="CenteredButton" style={{marginTop:"50px"}}>
            <h1 style={{color:"#EEEEEE", marginTop:"80px"}}>REGISTER PRODUCT</h1>
            ...
            <Form className="form" style={{marginTop:"30px"}}>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control value={serialNum} onChange={(e) => setSerialNum(e.target.value)}  className={"form-control:focus"} placeholder={"Serial Number"} style={{width: "300px", alignSelf:"center", margin:"auto", marginBottom:"20px", fontSize:12}}/>


                    <h5 style={{color:"#DDDDDD", fontSize:12, marginTop:"10px"}}>Warranty code</h5>
                    <div>

                        <Form.Control maxLength={8} className={"form-control:focus"} value={war1} onChange={(e) => setWar1(e.target.value)} placeholder={"XXXXXXXX"} style={{width: "100px", display:"inline-block", alignSelf:"center", margin:"auto", marginBottom:"20px", fontSize:11, textAlign:"center"}}/><span style={{color:"white", fontSize:12, margin:"5px"}}>-</span>
                        <Form.Control maxLength={4} className={"form-control:focus"} value={war2} onChange={(e) => setWar2(e.target.value)} placeholder={"XXXX"} style={{width: "70px", display:"inline-block", alignSelf:"center", margin:"auto", marginBottom:"20px", fontSize:11, textAlign:"center"}}/><span style={{color:"white", fontSize:12, margin:"5px"}}>-</span>
                        <Form.Control maxLength={4} className={"form-control:focus"} value={war3} onChange={(e) => setWar3(e.target.value)} placeholder={"XXXX"} style={{width: "70px", display:"inline-block", alignSelf:"center", margin:"auto", marginBottom:"20px", fontSize:11, textAlign:"center"}}/><span style={{color:"white", fontSize:12, margin:"5px"}}>-</span>
                        <Form.Control maxLength={4} className={"form-control:focus"} value={war4} onChange={(e) => setWar4(e.target.value)} placeholder={"XXXX"} style={{width: "70px", display:"inline-block", alignSelf:"center", margin:"auto", marginBottom:"20px", fontSize:11, textAlign:"center"}}/><span style={{color:"white", fontSize:12, margin:"5px"}}>-</span>
                        <Form.Control maxLength={12} className={"form-control:focus"} value={war5} onChange={(e) => setWar5(e.target.value)} placeholder={"XXXXXXXXXXXX"} style={{width: "140px", display:"inline-block", alignSelf:"center", margin:"auto", marginBottom:"20px", fontSize:11, textAlign:"center"}}/>
                    </div></Form.Group>
