...
import {addProductAPI, getAllBrands, getAllCategories} from "../../../API/Products";
        ...
        <div className="CenteredButton" style={{marginTop:"50px"}}>
            ...
            <Form className="form" style={{marginTop:"30px"}}>
                <Form.Group className="mb-3">
                    ...
                    <Form.Select value={category} onChange={(e) => setCategory(e.target.value)}  className={"form-select:focus"} style={{width: "300px", alignSelf:"center", margin:"auto", marginBottom:"20px"}}>
                        <option></option>
                        {categories.map(c => <option>{c}</option>)}
                    </Form.Select>
                    <Form.Label style={{color:"#DDDDDD"}}>Brand</Form.Label>
                    <Form.Select value={brand} onChange={(e) => setBrand(e.target.value)} className={"form-select:focus"} style={{width: "300px", alignSelf:"center", margin:"auto", marginBottom:"20px"}}>
                        <option></option>
                        {brands.map(b => <option>{b}</option>)}
                    </Form.Select>
                    <Form.Label style={{color:"#DDDDDD"}}>Name</Form.Label>
                    <Form.Control value={name} onChange={(e) => setName(e.target.value)}  className={"form-control:focus"} placeholder={"Product Name"} style={{width: "300px", alignSelf:"center", margin:"auto", marginBottom:"20px"}}/>
                </Form.Group>
