  ...
  function applyFilter() {
    setProductsList(
      allProducts.filter(
        (a) =>
          (categoryFilter === "" ||
            reformatCategory(a.category) === categoryFilter) &&
            ...
            <>
              ...
              >
                <div style={{ display: "inline-block", maxWidth: "250px" }}>
                  ...
                  >
                    <span
                      style={{ cursor: categoryFilter ? "pointer" : "" }}
                      onClick={() => setCategoryFilter("")}
                      className="input-group-text"
                    >
                      {categoryFilter ? crossIcon("black", 17) : filterIcon()}
                    </span>
                    <select
                      style={{ height: "40px", appearance: "searchfield" }}
                    ...
                    >
                      <option></option>
                      {categories.map((c) => (
                        <option>{reformatCategory(c)}</option>
                      ))}
                    </select>
                  </div>
                </div>
                ...
                <div style={{ display: "inline-block", maxWidth: "250px" }}>
                  ...
                  >
                    <span
                      style={{ cursor: brandFilter ? "pointer" : "" }}
                      onClick={() => setBrandFilter("")}
                      className="input-group-text"
                    >
                      {brandFilter ? crossIcon("black", 17) : filterIcon()}
                    </span>
                    <select
                      style={{ height: "40px", appearance: "searchfield" }}
                      className="form-control"
