...
function downArrowIcon(color, size) {
    return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color}
...
function plusIcon(color, size) {
    return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} className="bi bi-plus"
        viewBox="0 0 16 16">
        <path
...
function rightArrow(color, size) {
    return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color}
...
function crossIcon(color, size) {
    return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} className="bi bi-x"
        viewBox="0 0 16 16">
        <path
...
function sendIcon(color, size) {
    return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} className="bi bi-send"
        viewBox="0 0 16 16">
        <path
...
function filterIcon() {
    return <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-funnel-fill" viewBox="0 0 16 16">
...
function attachmentIcon(color,size){
    return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color}
...
export { filterIcon, editIcon, plusIcon, xIcon, downArrowIcon, rightArrow, leftArrow, closeIcon, crossIcon, attachmentIcon, sendIcon, caretDownIcon, caretUpIcon };