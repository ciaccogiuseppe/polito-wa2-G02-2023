...
async function updateClientAPI(updatePayload, email) {
  ...
  return api
    .put(APIURL + "/API/client/user/" + email, updatePayload)
    .then((response) => {
      return response;
    })
    .catch((err) => {
...
async function updateExpertAPI(updatePayload, email) {
  ...
  return api
    .put(APIURL + "/API/expert/user/" + email, updatePayload)
    .then((response) => {
      return response;
    })
    .catch((err) => {
...
async function updateManagerAPI(updatePayload, email) {
  ...
  return api
    .put(APIURL + "/API/manager/user/" + email, updatePayload)
    .then((response) => {
      return response;
    })
    .catch((err) => {
...
async function getProfileDetails(email) {
  ...
  return api
    .get(APIURL + "/API/authenticated/profiles/" + email)
    .then((response) => {
      return response;
    })
    .catch((err) => {
...
async function getExpertsByCategory(category) {
  ...
  return api
    .get(APIURL + "/API/manager/profiles/experts/" + category)
    .then((response) => {
      return response;
    })
    .catch((err) => {
